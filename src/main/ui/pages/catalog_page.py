...
class CatalogPage:
    ...
    def __init__(self, page: Page):
        ...
        self.basket_button = page.locator("[data-test='shopping-cart-link']")
        self.remove_button = page.locator("[data-test='remove-from-cart']")
    ...
    def open_product_details(self, product_name: str):
        ...
        expect(self.page.locator('[data-test="back-to-products"]')).to_be_visible()
